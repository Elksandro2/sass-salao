...
export const ADMIN_NAV_ITEMS: AdminNavItem[] = [
  ...
  { to: '/admin/products', label: 'Produtos (Venda)', icon: Package, allowedRoles: ['ADMIN'] },
  { to: '/admin/products/uso', label: 'Produtos (Uso)', icon: FlaskConical, allowedRoles: ['ADMIN'] },
  ...
  { to: '/admin/fixed-expenses', label: 'Gastos Fixos', icon: Receipt, allowedRoles: ['ADMIN', 'GERENTE_DE_ATENDIMENTO'] },
