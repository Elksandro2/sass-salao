...
class ProductControllerTest extends BaseControllerTest {
    ...
    void reactivateReturns200() throws Exception {
        ProductResponse dummyResponse = new ProductResponse(1L, "XYZ", 10, new BigDecimal("10.0"), true, null, null, null, null, null);
    ...
    void findAllReturnsPageOfProducts() throws Exception {
        ProductResponse response = new ProductResponse(1L, "Hair Spray", 20, new BigDecimal("15.50"), true, null, null, null, null, null);
    ...
    void findByIdReturnsProduct() throws Exception {
        ProductResponse response = new ProductResponse(2L, "Shampoo", 50, new BigDecimal("25.00"), true, null, null, null, null, null);
    ...
    void updateReturnsUpdatedProduct() throws Exception {
        ProductResponse response = new ProductResponse(2L, "New Shampoo", 40, new BigDecimal("28.00"), true, null, null, null, null, null);
