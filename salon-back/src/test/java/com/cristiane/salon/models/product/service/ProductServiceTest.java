...
class ProductServiceTest {
    ...
    void findAll_shouldReturnPageFromRepository() {
        // Arrange
        Product p1 = new Product(1L, "P1", new BigDecimal("10.0"), true, null, null, null, null);
        Product p2 = new Product(2L, "P2", new BigDecimal("20.0"), false, null, null, null, null);
    ...
    void findById_shouldReturnProduct_whenProductExists() {
        // Arrange
        Long id = 1L;
        Product p = new Product(id, "P", new BigDecimal("10.0"), true, null, null, null, null);
    ...
    void create_shouldSaveProductWithDefaultValues_whenRequestFieldsAreNull() {
        // Arrange
        ProductRequest request = new ProductRequest("New Product", new BigDecimal("15.0"), null, null, null, null, null);
        Product saved = new Product(1L, "New Product", new BigDecimal("15.0"), true, null, null, null, null);
    ...
    void create_shouldSaveProductWithSpecifiedValues_whenRequestFieldsAreProvided() {
        // Arrange
        ProductRequest request = new ProductRequest("Custom Product", new BigDecimal("15.0"), false, null, null, null, null);
        Product saved = new Product(1L, "Custom Product", new BigDecimal("15.0"), false, null, null, null, null);
        when(productRepository.save(any(Product.class))).thenReturn(saved);
    ...
    void update_shouldThrowResourceNotFoundException_whenProductDoesNotExist() {
        // Arrange
        Long id = 1L;
        ProductRequest request = new ProductRequest("Updated", new BigDecimal("20.0"), true, null, null, null, null);
        when(productRepository.findById(id)).thenReturn(Optional.empty());
    ...
    void update_shouldOnlyUpdateNonNullFields() {
        // Arrange
        Long id = 1L;
        Product product = new Product(id, "Old Name", new BigDecimal("10.0"), true, null, null, null, null);
        ProductRequest request = new ProductRequest("New Name", new BigDecimal("12.0"), null, null, null, null, null);

        Product saved = new Product(id, "New Name", new BigDecimal("12.0"), true, null, null, null, null);
    ...
    void delete_shouldMarkProductAsInactive() {
        // Arrange
        Long id = 1L;
        Product product = new Product(id, "P", new BigDecimal("10.0"), true, null, null, null, null);
        when(productRepository.findById(id)).thenReturn(Optional.of(product));
    ...
    void reactivate_shouldMarkProductAsActive() {
        // Arrange
        Long id = 1L;
        Product product = new Product(id, "P", new BigDecimal("10.0"), false, null, null, null, null);
        Product saved = new Product(id, "P", new BigDecimal("10.0"), true, null, null, null, null);
